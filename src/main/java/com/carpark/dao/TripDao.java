...
public class TripDao {
	...
	public List<Trip> searchTrip(String date, String key, int pageNumber, int elementPerPage) {
		try (Connection connection = ConnectionDB.getInstance().getConnection();
				PreparedStatement preparedStatement = connection.prepareStatement(searchTrip)) {
	...
	public void EditTrip(String destination, String departime, String driver, String cartype, String maxtick, int id) {
	...
	public void addTrip(String cartype, String departureDate, String departureTime, String destination, String driver,
			String maxticket) {
		try (Connection connection = ConnectionDB.getInstance().getConnection();
