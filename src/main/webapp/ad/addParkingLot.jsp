						...
						<table style="width: 50%;">
							<tr>
								...
								<td><input class="box" type="text" name="parkingName"
									placeholder="Enter parking lot" maxlength="50"/></td>
							</tr>
							<tr>
								<td><strong>Place(*)</strong></td>
								<td><select class="box" name="place">
										<c:forEach items="${list2}" var="i">
											<option value="${i.parkingId}">${i.place}</option>
										</c:forEach>
								</select></td>
							</tr>
							...
							<tr>
								...
								<td><input class="box" name="area" placeholder="Enter area" maxlength="50" type = "number" style="align-items: inherit;">
								<td><strong>&nbsp&nbsp&nbsp(m2)</strong>
							</tr>
							
							<tr>
								<td><strong>Price(*)</strong></td>
								<td><input class="box" name="price" placeholder="Enter price" maxlength="50" type = "number" style="align-items: inherit;">
