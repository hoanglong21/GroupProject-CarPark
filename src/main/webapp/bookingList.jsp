...
<body>
	<div style="overflow-x: hidden;">
		...
		<div class="row align-items-center" style="margin-top: 20px; display: flex; align-items: stretch !important;">
			...
			<div class="col-10"
				...
				<div class="box" style="margin-top: 0; width: 100%; all: initial">
					<form style="all: initial;" id="search-form" action="bookinglist" method="post">
							...
							<div class="col-auto" style="margin-right: 1%; width: 30%;">
								...
								<div class="input-group mb-2">
									...
									<input id="search" name="search" class="form-control" type="text"
										placeholder="Booking Office Search" maxlength="50" value="${search}">
								</div>
							</div>
	...
	$(".btn-last").on("click", (e) => {
		...
		$.ajax(
			{
				url: 'http://localhost:8080/CarPark/bookinglist',
				type: 'POST',
				data: {
